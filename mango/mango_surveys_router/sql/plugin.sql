...
CREATE TABLE IF NOT EXISTS `mango_results_facilitator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `survey_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_token` varchar(36) COLLATE utf8_unicode_ci NOT NULL,
  `matching_table_in_limesurvey` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mango_iat_panel_split` (
  ...
  `iat_version` BOOLEAN NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1;
